...
export const ImportForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // ✅ EVENTO DE CONVERSIÓN PARA GA4 / GOOGLE ADS
    if (typeof window !== "undefined" && (window as any).gtag) {
      (window as any).gtag("event", "lead_email", {
        event_category: "conversion",
        event_label: "Formulario Importación",
      });
    }
...
`;
    ...
    const mailtoLink = `mailto:info@premiumgermancars.com?subject=${encodeURIComponent(
      subject
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/3">
            ...
            <p className="text-gray-400 font-light text-lg leading-relaxed mb-8">
              El mercado alemán es inmenso. Dinos exactamente qué modelo, color y
              extras deseas, y nosotros rastreamos las unidades oficiales
              disponibles para ti.
            </p>
            ...
            <div className="bg-metallic-900 border border-white/10 p-8 md:p-12 shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="group">
                    <label className="block text-xs uppercase tracking-widest text-gray-500 mb-3 group-focus-within:text-gold-400 transition-colors">
                      Marca
                    </label>
                    <select
                      name="brand"
                    ...
                    >
                      <option value="" className="bg-metallic-900">
                        Seleccionar marca...
                      </option>
                      <option value="Audi" className="bg-metallic-900">
                        Audi
                      </option>
                      <option value="BMW" className="bg-metallic-900">
                        BMW
                      </option>
                      <option
                        value="Mercedes-Benz"
                        className="bg-metallic-900"
                      >
                        Mercedes-Benz
                      </option>
                      <option value="Porsche" className="bg-metallic-900">
                        Porsche
                      </option>
                      <option value="Otro" className="bg-metallic-900">
                        Otra
                      </option>
                    </select>
                  </div>
