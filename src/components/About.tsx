        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
           <div className="lg:w-1/2">
              ...
              <div className="space-y-6 text-gray-300 leading-relaxed text-justify font-light">
                ...
                <p>
                  En <strong className="text-white">Premium German Cars</strong> cuidamos cada detalle: desde la selección del vehículo hasta que se encuentre listo para ti, todo pensado para ofrecer transparencia, confianza y una experiencia personalizada. Creemos que comprar un coche premium no debe ser complicado: debe ser un proceso emocionante y satisfactorio.
                </p>
