            ...
            <div className="bg-[#0a0a0a]/50 p-4 sm:p-6 md:p-8 rounded-lg border border-white/5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-3 p-3 bg-black/40 rounded border border-white/5 transition-colors hover:border-gold-400/30"
                  >
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-[#0a0a0a] border border-white/10 p-4 sm:p-6 md:p-8 rounded-lg sticky top-32 shadow-2xl">
              ...
              <p className="text-[10px] text-center text-gray-500 mt-6 leading-tight uppercase tracking-tighter">
                *Financiación a medida disponible.
                <br />
