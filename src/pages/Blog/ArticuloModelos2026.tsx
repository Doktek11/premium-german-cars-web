...
import { CheckCircle, AlertTriangle, Mail, Star, Car, ShieldCheck, Zap } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-invert prose-gold max-w-none text-gray-300 leading-relaxed">
            ...
            <p className="mb-8 text-base md:text-lg">
              Alemania mantiene su histórica disciplina de mantenimiento, pero en 2026 hay dos factores clave adicionales que refuerzan la decisión:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-justify">
              <div className="bg-white/5 p-6 border-t-2 border-gold-400">
                ...
                <p className="text-sm text-gray-400">Es mucho más sencillo encontrar unidades con acabados deportivos (M Sport, S-Line, AMG Line) combinados con motorizaciones eficientes.</p>
              </div>
              <div className="bg-white/5 p-6 border-t-2 border-gold-400">
                <h3 className="text-white font-bold mb-2 uppercase text-sm tracking-widest">Movilidad garantizada</h3>
                <p className="text-sm text-gray-400">Seleccionamos unidades que aseguran etiquetas ambientales C o ECO, imprescindibles para las Zonas de Bajas Emisiones (ZBE) en España.</p>
              </div>
            </div>
            ...
            <h2 className="text-2xl font-serif font-bold text-gold-400 mt-12 mb-6 uppercase tracking-wider text-justify">
              Trazabilidad real: el verdadero lujo al importar un coche de Alemania
            </h2>
            <p className="mb-6 text-base md:text-lg text-justify">
              En Premium German Cars filtramos más del 90 % de la oferta disponible. Solo trabajamos con vehículos que cumplen criterios estrictos:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              <div className="bg-white/5 border border-white/10 p-5 rounded-sm italic text-sm">"Procedencia clara (matriz de marca o concesionarios oficiales)."</div>
              <div className="bg-white/5 border border-white/10 p-5 rounded-sm italic text-sm">"Mantenimientos sellados siempre en servicio oficial."</div>
              <div className="bg-white/5 border border-white/10 p-5 rounded-sm italic text-sm">"Kilometraje verificado y documentado mediante registros."</div>
              <div className="bg-white/5 border border-white/10 p-5 rounded-sm italic text-sm">"La transparencia no es un extra: es la base de la seguridad."</div>
            </div>
            ...
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-gold-400 mt-16 mb-8 uppercase tracking-wider text-center">
              Nuestra selección inteligente de coches para importar en 2026
            </h2>
            ...
            <div className="mb-10 p-6 md:p-8 border border-white/10 bg-metallic-900/30 rounded-sm">
              ...
              <p className="mb-4 text-sm md:text-base"><strong>Qué buscamos para ti:</strong> Versiones 118i o 120d, un solo propietario y mantenimiento completo en BMW.</p>
              <p className="text-gold-400 italic font-medium text-sm md:text-base flex items-center gap-2 italic">
                <Star size={14} /> Valor para ti: Excelente equilibrio entre consumo, fiabilidad y alta demanda en España.
              </p>
            </div>
            ...
            <div className="mb-10 p-6 md:p-8 border border-white/10 bg-metallic-900/30 rounded-sm">
              ...
              <p className="mb-4 text-sm md:text-base"><strong>Qué buscamos para ti:</strong> Historial de servicio digital completo y certificación de estado mecánico.</p>
              <p className="text-gold-400 italic font-medium text-sm md:text-base flex items-center gap-2 italic">
                <Star size={14} /> Valor para ti: El coche “líquido” por excelencia: salida rápida en reventa y gran retención de valor.
              </p>
            </div>
            ...
            <div className="mb-10 p-6 md:p-8 border border-white/10 bg-metallic-900/30 rounded-sm">
              ...
              <p className="mb-2 text-sm md:text-base"><strong>¿Por qué es interesante?</strong> Calidad de rodadura superior. Priorizamos versiones con microhibridación para obtener la etiqueta ECO.</p>
              <p className="mb-4 text-sm md:text-base"><strong>Qué buscamos para ti:</strong> Equipamiento S-Line y trazabilidad 100 % oficial.</p>
              <p className="text-gold-400 italic font-medium text-sm md:text-base flex items-center gap-2 italic">
                <Star size={14} /> Valor para ti: Diseño moderno y movilidad sin restricciones en grandes ciudades.
              </p>
            </div>
            ...
            <div className="mb-10 p-6 md:p-8 border border-white/10 bg-metallic-900/30 rounded-sm">
              ...
              <p className="mb-2 text-sm md:text-base"><strong>¿Por qué es una oportunidad?</strong> Cuenta con la interfaz MBUX. En Alemania accedemos a unidades de flotas premium con muy poco uso.</p>
              <p className="mb-4 text-sm md:text-base"><strong>Qué buscamos para ti:</strong> Kilometraje real verificable y ausencia total de daños estructurales.</p>
              <p className="text-gold-400 italic font-medium text-sm md:text-base flex items-center gap-2 italic">
                <Star size={14} /> Valor para ti: Diseño atractivo y demanda constante que protege tu inversión a futuro.
              </p>
            </div>
            ...
            <div className="mb-10 p-6 md:p-8 border border-white/10 bg-metallic-900/30 rounded-sm">
              ...
              <p className="mb-2 text-sm md:text-base"><strong>¿Por qué merece atención?</strong> Combina espacio y dinamismo. Ideal para familias que buscan un SUV premium polivalente.</p>
              <p className="mb-4 text-sm md:text-base"><strong>Qué buscamos para ti:</strong> Trazabilidad clara desde origen y estado estético impecable.</p>
              <p className="text-gold-400 italic font-medium text-sm md:text-base flex items-center gap-2 italic">
                <Star size={14} /> Valor para ti: Los SUV compactos son el segmento que mejor mantiene el precio en España.
              </p>
            </div>
            ...
            <section className="mt-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 border border-white/5">
                  <h4 className="font-bold text-white text-sm mb-2 uppercase">1. Inspección</h4>
                  <p className="text-xs text-gray-400">Revisión mecánica y estructural basada en datos contrastados.</p>
                </div>
                <div className="p-4 border border-white/5">
                  <h4 className="font-bold text-white text-sm mb-2 uppercase">2. Gestión</h4>
                  <p className="text-xs text-gray-400">Importación, ITV, matriculación y gestión integral de impuestos.</p>
                </div>
                <div className="p-4 border border-white/5">
                  <h4 className="font-bold text-white text-sm mb-2 uppercase">3. Entrega</h4>
                  <p className="text-xs text-gray-400">Tú solo disfrutas del coche con la tranquilidad de una decisión correcta.</p>
                </div>
              </div>
            </section>
            ...
            <section className="mt-20 mb-12 bg-white/5 border border-white/10 p-6 md:p-10 rounded-sm">
              ...
              <div className="space-y-6 text-base">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Porque suele esconder falta de historial oficial. A largo plazo, las averías superan el ahorro inicial.</p>
                </div>
                <div>
                  <h4 className="font-bold text-gold-400 mb-1 uppercase text-xs tracking-widest">¿Compensa frente a España?</h4>
                  <p className="text-gray-400 text-sm">Sí, por el binomio estado + equipamiento. Obtienes un coche superior por el mismo presupuesto.</p>
                </div>
              </div>
            </section>
            ...
            <div className="mt-20 p-1 bg-gradient-to-r from-gold-600 to-gold-400">
              <div className="bg-black p-8 md:p-12 text-center">
                ...
                <p className="text-gray-400 mb-8 max-w-md mx-auto text-sm">En Premium German Cars analizamos cada vehículo como si fuera para nosotros mismos.</p>
