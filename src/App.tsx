          ...
          <div className="prose prose-invert prose-gold max-w-none text-gray-300 leading-relaxed">
            ...
            <section className="mb-24">
              ...
              <p className="text-lg mb-8">
                El mercado alemán sigue siendo el mejor lugar para encontrar unidades diésel modernas (Euro 6d) en estado impecable.
              </p>
              <div className="grid md:grid-cols-2 gap-8 bg-[#0a0a0a] p-8 border border-white/5">
                ...
                <div className="border-l border-white/10 pl-8">
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Es el motor ideal para devorar kilómetros por la AP-7 con una sola carga de depósito. No lo recomendamos si tu uso es urbano.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="flex flex-col md:flex-row gap-12 items-start">
                <div className="flex-1">
                  <p className="text-lg leading-relaxed mb-6">
                    Si puedes cargar a diario, el PHEV es el vencedor absoluto. La mayoría emiten menos de 45 g/km de CO2, lo que exime del impuesto de matriculación en España.
                  </p>
                </div>
                <div className="w-full md:w-72 bg-white/5 p-6 border border-white/10">
                  ...
                  <p className="text-[10px] text-gray-500 uppercase tracking-tighter">Impuesto de Matriculación</p>
                </div>
              </div>
            </section>

            {/* 4. GASOLINA - CORREGIDO AQUÍ */}
            <section className="mb-24">
              <h2 className="text-[10px] uppercase tracking-[0.4em] font-black text-gold-400 mb-6 border-b border-gold-400/20 pb-4 flex items-center gap-3">
            ...
            <div className="bg-[#0a0a0a] border border-gold-400/20 p-12 text-center relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-center">
                  <a 
                    href="https://wa.me/34603743608?text=Hola,%20tengo%20dudas%20sobre%20qué%20motor%20elegir." 
                    target="_blank"
