import { handleVehicleTaxEstimateRequest, sendVehicleTaxEstimateResponse } from "../src/lib/vehicleTaxEstimateApi.mjs";
...
export default async function handler(req, res) {
  try {
    const response = await handleVehicleTaxEstimateRequest(req, {
