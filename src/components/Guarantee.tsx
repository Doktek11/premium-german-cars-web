...
export const Guarantee: React.FC = () => {
  return (
    <section id="guarantee" className="py-16 sm:py-20 md:py-32 bg-[#0a0a0a] border-t border-white/5 overflow-hidden">
          ...
          <div className="order-2 lg:order-1 relative">
            ...
            <div className="relative z-10 overflow-hidden rounded shadow-2xl bg-black/40">
              <img
                ...
                className="w-full h-[250px] sm:h-[300px] md:h-auto object-cover grayscale hover:grayscale-0 transition-all duration-700 transform hover:scale-105"
                loading="lazy"
                decoding="async"
                width="600"
                height="450"
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              {[
                ...
                <div key={i} className="flex gap-3 sm:gap-4 md:gap-6 group">
